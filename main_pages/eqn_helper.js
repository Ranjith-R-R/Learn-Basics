    ...
    import {convertLatexToMarkup} from '../lib/mathlive-master/mathlive.min.js';
        ...
        document.querySelector('#renopt').addEventListener('click', (ev) => {
            ...
            {
            var r = document.getElementById('opt'+no).value;
            if(r == "")
            {
        ...
        document.querySelector('#renopt2').addEventListener('click', (ev) => {
            var r = document.getElementById('fibans').value;
            if(r != "")
            {
                ...
                if(a == 0)
                {
                    ...
                    var tex = document.getElementById('efibans').innerHTML;
                    document.getElementById('efibans').innerHTML = tex + r[i] + s; 
                    i+=1;
                }else
                {
                    var tex = document.getElementById('efibans').innerHTML;
                    ...
                    document.getElementById('efibans').innerHTML = tex + convertLatexToMarkup(rrr);
                    i=(j+1);
                    a=0;
                }
            }
